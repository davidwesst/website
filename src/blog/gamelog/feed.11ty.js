...
export default class GamelogFeed {
  data() {
    return {
      permalink: "/blog/gamelog/feed.xml",
      eleventyExcludeFromCollections: true,
    };
  }

  render(data) {
    const posts = data.collections.posts.filter((post) => post.series === "gamelog");

    return `<?xml version="1.0" encoding="utf-8"?>
<rss version="2.0">
  <channel>
    <title>${escapeXml(data.site.title)} Gamelog</title>
    <link>${escapeXml(absoluteUrl(data.site, "/blog/?series=gamelog"))}</link>
