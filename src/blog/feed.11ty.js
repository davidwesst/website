...
export default class BlogFeed {
  ...
  render(data) {
    const posts = data.collections.posts.filter((post) => post.series === "blog");

    return `<?xml version="1.0" encoding="utf-8"?>
<rss version="2.0">
  <channel>
    <title>${escapeXml(data.site.title)} Blog</title>
    <link>${escapeXml(absoluteUrl(data.site, "/blog/"))}</link>
