...
redirectFrom:
  - >-
    /blog/how-to-compile-typescript-into-a-single-file-with-systemjs-modules-with-gulp/index.html
---
I've been messing around with TypeScript again for my [game project](/blog/new-post-initial-thoughts-on-phaser/) and wanted a module loader to consume the single file produced by the TypeScript compiler. This time around I decided to use SystemJS and figured I'd share the lessons I learned along the way.
...
##### Previous Post
I also posted about doing the same sort of thing [with AMD and RequireJS](/blog/typescript-with-amd-and-gulp/) complete with [a GitHub sample project](https://github.com/davidwesst/ts-project-template)
...
![Illustration for “How to Compile TypeScript into a Single File with SystemJS Modules with Gulp”.](./TyAgU0N.png)
...
![Illustration for “How to Compile TypeScript into a Single File with SystemJS Modules with Gulp”.](./gUGeHfI.png)
