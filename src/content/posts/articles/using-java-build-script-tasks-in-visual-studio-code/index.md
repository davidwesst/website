...
topics:
  ...
  - vscode
redirectFrom:
  - /blog/using-java-build-script-tasks-in-visual-studio-code/index.html
---
...
<!-- MISSING
*Archived image unavailable: /blog/Using-Java-Build-Script-Tasks-in-Visual-Studio-Code/hellolink-file.png.*
-->

Next up, I want to create a custom build task. We'll call our task ```getSword```.

<!-- MISSING
*Archived image unavailable: /blog/Using-Java-Build-Script-Tasks-in-Visual-Studio-Code/gradle-project.png.*
-->
...
<!-- MISSING
*Archived image unavailable: /blog/Using-Java-Build-Script-Tasks-in-Visual-Studio-Code/gradle-task.png.*
-->
When we run it, by pressing ```Ctrl + P``` and entering ```task gradle``` we should get the output window displaying our gradle command.

<!-- MISSING
*Archived image unavailable: /blog/Using-Java-Build-Script-Tasks-in-Visual-Studio-Code/gradle-task-output.png.*
-->
...
<!-- MISSING
*Archived image unavailable: /blog/Using-Java-Build-Script-Tasks-in-Visual-Studio-Code/tasks-intellisense.png.*
-->
...
<!-- MISSING
*Archived image unavailable: /blog/Using-Java-Build-Script-Tasks-in-Visual-Studio-Code/gradle-error.png.*
-->
...
<!-- MISSING
*Archived image unavailable: /blog/Using-Java-Build-Script-Tasks-in-Visual-Studio-Code/complete.png.*
-->
