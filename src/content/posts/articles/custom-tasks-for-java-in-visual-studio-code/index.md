...
topics:
  ...
  - vscode
redirectFrom:
  - /blog/custom-tasks-for-java-in-visual-studio-code/index.html
---
...
<!-- MISSING
*Archived image unavailable: /blog/Custom-Tasks-for-Java-in-Visual-Studio-Code/configure-task-runner.png.*
-->
...
<!-- MISSING
*Archived image unavailable: /blog/Custom-Tasks-for-Java-in-Visual-Studio-Code/new-javac-task.png.*
-->
4. Select it to run it, and assuming you have an error, it should display something in the output window.
<!-- MISSING
*Archived image unavailable: /blog/Custom-Tasks-for-Java-in-Visual-Studio-Code/javac-output.png.*
-->
...
<!-- MISSING
*Archived image unavailable: /blog/Custom-Tasks-for-Java-in-Visual-Studio-Code/error-inline.png.*
-->
...and if we bring up our warnings by hitting ```Ctrl + Shift + M``` we should see:
<!-- MISSING
*Archived image unavailable: /blog/Custom-Tasks-for-Java-in-Visual-Studio-Code/error-warning.png.*
-->
