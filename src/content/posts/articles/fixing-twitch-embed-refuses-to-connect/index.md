...
![Twitch embedded iframe stating: Failed to load resource: the server responded with a status of 403](./twitch-player-misconfigured.png)
...
![Twitch embedded iframe stating: player.twitch.tv refused to connect](./twitch-player-refuse-to-connect.png)
