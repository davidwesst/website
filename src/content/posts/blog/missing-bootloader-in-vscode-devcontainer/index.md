---
id: blog/missing-bootloader-in-vscode-devcontainer
source: davidwesst.github.io
docType: post
series: blog
slug: missing-bootloader-in-vscode-devcontainer
...
taxonomy:
  tags:
    ...
    - vscode
  categories: []
canonicalUrl: /blog/missing-bootloader-in-vscode-devcontainer/
legacyUrls:
  - /blog/missing-bootloader-in-vscode-devcontainer/index.html
meta:
  sourceMeta:
    title: Cannot Find Module Bootloader.js in VSCode DevContainer
    date: 2022-01-18T02:42:00.000Z
    tags:
      - devcontainer
      - nodejs
      - vscode
    description: >-
      Problem: When running node commands from within a DevContainer, you
      receive the error 'Cannot find module bootloader.js'. This post contains
      the solution.
    social_image: ./error-message-tty.png
    social_image_alt: >-
      Windows terminal with a Linux penguin in the background of the terminal.
      The text on the terminal reads: 'Error: Cannot find module
