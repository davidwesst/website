---
id: blog/using-overflow-ellipsis-in-inline-flex
source: davidwesst.github.io
docType: post
series: blog
slug: using-overflow-ellipsis-in-inline-flex
...
taxonomy:
  tags:
    ...
    - flexbox
  categories: []
canonicalUrl: /blog/using-overflow-ellipsis-in-inline-flex/
legacyUrls:
  - /blog/using-overflow-ellipsis-in-inline-flex/index.html
meta:
  sourceMeta:
    title: 'Using text-overflow:ellipsis with Inline Flex'
    date: 2016-02-29T15:58:40.000Z
    tags:
      - html
      - css
      - flexbox
    description: >-
      Two out of three Dave's hit this obscure CSS problem that turned out to be
      expected behaviour. David Wesst walks us through the reason why and how to
      fix it.
---
