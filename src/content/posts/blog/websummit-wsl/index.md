...
taxonomy:
  ...
  categories:
    - development
canonicalUrl: /blog/websummit-wsl/
legacyUrls:
  - /blog/websummit-wsl/index.html
meta:
  sourceMeta:
    title: 'Windows Subsystem for Linux is Cool. No really, it is.'
    date: 2017-09-20T12:35:00.000Z
    categories:
      - development
    tags:
      - microsoft-edge
      ...
      - wsl
    description: >-
      With the Fall Creators update of Windows 10, you can go to the Windows
      Store and install Linux. Yeah, that's a thing now and it's pretty cool.
---
