---
id: blog/how-to-blog-with-vsts-part-1
source: davidwesst.github.io
docType: post
series: blog
slug: how-to-blog-with-vsts-part-1
...
summary: >-
  ...
  how _any_ project can benefit from ALM practices using VSTS. In part 1 of 5,
  we get things setup.
dates:
...
taxonomy:
  tags:
    ...
    - hexo
  categories: []
canonicalUrl: /blog/how-to-blog-with-vsts-part-1/
legacyUrls:
  - /blog/how-to-blog-with-vsts-part-1/index.html
meta:
  sourceMeta:
    title: How to Blog with VSTS (Part 1)
    date: 2016-10-31T08:43:31.000Z
    tags:
      - visual-studio-team-services
      - vsts
      - alm
    ...
    description: >-
      I wanted to understand how to use Visual Studio Team Services (VSTS) for a
      "real" project. Being a noob, I decided to move my blog to VSTS to
      understand how _any_ project can benefit from ALM practices using VSTS. In
...
[1]: /blog/How-to-Blog-with-VSTS-Part-1/
[2]: /blog/How-to-Blog-with-VSTS-Part-2/
[3]: /blog/How-to-Blog-with-VSTS-Part-3/
[4]: /blog/How-to-Blog-with-VSTS-Part-4/
[5]: #
