---
id: blog/how-to-use-highlight-js-with-bower-and-gulp
source: davidwesst.github.io
docType: post
series: blog
slug: how-to-use-highlight-js-with-bower-and-gulp
...
taxonomy:
  tags:
    ...
    - javascript
  categories: []
canonicalUrl: /blog/how-to-use-highlight-js-with-bower-and-gulp/
legacyUrls:
  - /blog/how-to-use-highlight-js-with-bower-and-gulp/index.html
meta:
  sourceMeta:
    title: How to Use Highlight.Js with Bower and Gulp
    date: 2016-08-29T10:07:11.000Z
    tags:
      - gulp
      - bower
      - highlightjs
    ...
    description: >-
      One of the best libraries I've seen for syntax highlighting on the web is
      highlight.js, IMHO. The catch to using the library is that it takes a bit
      more effort to setup than just adding a script tag and being done with it.
      In this post, I'll walk you through the steps I took to get this up and
      running with Bower and Gulp.
---
