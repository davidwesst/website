---
id: blog/why-do-you-requirejs
source: davidwesst.github.io
docType: post
series: blog
slug: why-do-you-requirejs
...
taxonomy:
  tags:
    ...
    - requirejs
  categories: []
canonicalUrl: /blog/why-do-you-requirejs/
legacyUrls:
  - /blog/why-do-you-requirejs/index.html
meta:
  sourceMeta:
    title: Why do you RequireJS?
    tags:
      - code
      - requirejs
    date: 2014-10-07T17:15:11.000Z
    description: >-
      Get it? RequireJS is a dependency management framework I use in JavaScript
      to manage...well my dependencies. But, the title is a play on words
