---
id: >-
  blog/how-to-compile-typescript-into-a-single-file-with-systemjs-modules-with-gulp
source: davidwesst.github.io
docType: post
series: blog
slug: how-to-compile-typescript-into-a-single-file-with-systemjs-modules-with-gulp
...
meta:
  sourceMeta:
    title: >-
      How to Compile TypeScript into a Single File with SystemJS Modules with
      Gulp
    date: 2017-03-14T09:47:22.000Z
    tags:
      - javascript
      - typescript
      - systemjs
      ...
      - gulpjs
    description: >-
      I decided to move a TypeScript project from AMD modules (i.e. RequireJS)
      to SystemJS, still using Gulp. In this post, I walk you through the sample
      project I've created and share the lessons I learned along the way.
---
