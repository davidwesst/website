---
id: blog/fixing-twitch-embed-refuses-to-connect
source: davidwesst.github.io
docType: post
series: blog
slug: fixing-twitch-embed-refuses-to-connect
...
taxonomy:
  tags:
    ...
    - bug
  categories: []
canonicalUrl: /blog/fixing-twitch-embed-refuses-to-connect/
legacyUrls:
  - /blog/fixing-twitch-embed-refuses-to-connect/index.html
meta:
  sourceMeta:
    title: >-
      Working around 'Refuses to Connect' Issues with IFrame Embedded Twitch
      Players
    ...
    tags:
      ...
      - bug
    description: >-
      With me doing more livecoding sessions on Twitch, I wanted to embed some
      clips into my blog posts and hit some weird issues. I managed to get it
