---
id: blog/windows-not-required-video
source: davidwesst.github.io
docType: post
series: blog
slug: windows-not-required-video
...
taxonomy:
  ...
  categories: []
canonicalUrl: /blog/windows-not-required-video/
legacyUrls:
  - /blog/windows-not-required-video/index.html
meta:
  sourceMeta:
    title: Windows Not Required - The New Microsoft Development Story (Video)
    date: 2016-10-03T10:47:31.000Z
    tags:
      - .net-core
      - docker
      - powershell
      ...
      - visual-studio-team-services
    description: >-
      I delivered a presentation at the Winnipeg .NET User Group last week,
      where I recorded it and posted it on YouTube. I go over a number of
      Microsoft development tools and technologies that don't require Windows
      and deliver the demos on my Linux machine.
---
