---
id: blog/from-travis-ci-to-github-actions
source: davidwesst.github.io
docType: post
series: blog
slug: from-travis-ci-to-github-actions
...
taxonomy:
  ...
  categories: []
canonicalUrl: /blog/from-travis-ci-to-github-actions/
legacyUrls:
  - /blog/from-travis-ci-to-github-actions/index.html
meta:
  sourceMeta:
    title: From Travis CI to GitHub Actions (and GitHub Pages)
    date: 2020-11-10T18:36:00.000Z
    tags:
      - github-actions
      - github-workflow
      - travis-ci
      ...
      - continuous-deployment
    description: >-
      We recently migrated the continuous integration and deployment workflow
      for the Western Devs website from Travis CI to GitHub Actions. These are
      the steps I followed to get it done.
---
