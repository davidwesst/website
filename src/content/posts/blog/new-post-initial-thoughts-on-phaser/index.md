---
id: blog/new-post-initial-thoughts-on-phaser
source: davidwesst.github.io
docType: post
series: blog
slug: new-post-initial-thoughts-on-phaser
...
taxonomy:
  tags:
    ...
    - phaser
  categories: []
canonicalUrl: /blog/new-post-initial-thoughts-on-phaser/
legacyUrls:
  - /blog/new-post-initial-thoughts-on-phaser/index.html
meta:
  sourceMeta:
    title: Initial Thoughts on Using Phaser
    date: 2017-03-07T06:00:00.000Z
    updated: 2017-03-07T06:00:00.000Z
    tags:
      - javascript
      - typescript
      - phaser
    description: >-
      As a side project, I started making another JavaScript-based video game
      and decided to go with Phaser as my framework of choice. Here are my
      initial thoughts about Phaser after using it on my project for the past
      two months.
---
