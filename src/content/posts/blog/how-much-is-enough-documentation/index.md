---
id: blog/how-much-is-enough-documentation
source: davidwesst.github.io
docType: post
series: blog
slug: how-much-is-enough-documentation
...
summary: >-
  ...
  the context I forget after putting a project on the shelf, or explains how to
...
media:
  ...
  imageAlt: >-
    File tree of a source code repository with a 'docs' folder containing a
    sub-folder entitled 'decisions' with a series of markdown files documenting
    technical decisions for the project.
  mediaType: image/png
canonicalUrl: /blog/how-much-is-enough-documentation/
legacyUrls:
  - /blog/how-much-is-enough-documentation/index.html
meta:
  sourceMeta:
    title: How much is enough documentation?
    ...
    tags:
      ...
      - contributing.md
    description: >-
      Documentation is important, but it takes a lot of time and if you are a
      solo developer, what documentation to you really need? Still, good docs
      can provide the context I forget after putting a project on the shelf, or
      explains how to fix something in older code I use, but haven't touched in
      a long time. So how much is 'enough' documentation and what types of
      documentation do I need to invest in give my future self the the best
      value for the effort I put in?
    featured_image: ./repo-with-docs_og.png
    featured_image_alt: >-
      File tree of a source code repository with a 'docs' folder containing a
      sub-folder entitled 'decisions' with a series of markdown files
      documenting technical decisions for the project.
