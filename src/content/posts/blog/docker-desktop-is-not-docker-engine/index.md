---
id: blog/docker-desktop-is-not-docker-engine
source: davidwesst.github.io
docType: post
series: blog
slug: docker-desktop-is-not-docker-engine
...
media:
  ...
  imageAlt: >-
    A blue rectangular button with the words 'Download Docker Desktop' for Linux
    written on it. Above it, there is red text with an arrow pointing to the
    button that says 'This is NOT Docker Engine'.
  mediaType: image/png
canonicalUrl: /blog/docker-desktop-is-not-docker-engine/
legacyUrls:
  - /blog/docker-desktop-is-not-docker-engine/index.html
meta:
  sourceMeta:
    title: Docker Desktop for Linux is not the same as Docker Engine
    ...
    tags:
      ...
      - github-workflow
    description: >-
      With Docker for Desktop available for Linux (which I like), I managed to
      get myself confused regarding its role on my Linux-based development
      machine. This post clarifies a few things I discovered while triaging an
      issue I had trying to test my GitHub Workflows locally.
    featured_image: ./docker-desktop-is-not-docker-engine.png
    image_type: image/png
    featured_image_alt: >-
      A blue rectangular button with the words 'Download Docker Desktop' for
      Linux written on it. Above it, there is red text with an arrow pointing to
