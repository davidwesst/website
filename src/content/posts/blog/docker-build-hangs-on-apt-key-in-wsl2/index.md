---
id: blog/docker-build-hangs-on-apt-key-in-wsl2
source: davidwesst.github.io
docType: post
series: blog
slug: docker-build-hangs-on-apt-key-in-wsl2
...
media:
  ...
  imageAlt: >-
    A light blue cartoon style whale, meant to resemble the Docker logo, with a
    yellow-orange beak, like the Linux penguin, holding a key in it's mouth.
    Drawn with very small squares.
  mediaType: image/png
  credit:
    derived-from: 'https://labs.openai.com/s/z8Gdu46DdNOGjAKCTXiY1mmW'
canonicalUrl: /blog/docker-build-hangs-on-apt-key-in-wsl2/
legacyUrls:
  - /blog/docker-build-hangs-on-apt-key-in-wsl2/index.html
meta:
  sourceMeta:
    title: Docker Build Hangs When Adding Key with apt-key in WSL2
    date: '2023-01-11T12:00:00-06:00'
    description: >-
      The solution to the problem where an apt-key command seems to run forever
    ...
    featured_image_alt: >-
      A light blue cartoon style whale, meant to resemble the Docker logo, with
      a yellow-orange beak, like the Linux penguin, holding a key in it's mouth.
      Drawn with very small squares.
