---
id: blog/how-to-fork-like-a-boss
source: davidwesst.github.io
docType: post
series: blog
slug: how-to-fork-like-a-boss
...
taxonomy:
  tags:
    ...
    - open-source
  categories: []
canonicalUrl: /blog/how-to-fork-like-a-boss/
legacyUrls:
  - /blog/how-to-fork-like-a-boss/index.html
meta:
  sourceMeta:
    title: How to fork (a repo) like a boss!
    ...
    tags:
      ...
      - open-source
    description: >-
      Everyone thinks about forking. It is a natural thing, yet how do get the
      job done and fork? I used to ask myself the same thing, until I learned
      these pro-tips and forked like a boss.
---
