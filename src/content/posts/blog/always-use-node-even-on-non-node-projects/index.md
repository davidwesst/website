---
id: blog/always-use-node-even-on-non-node-projects
source: davidwesst.github.io
docType: post
series: blog
slug: always-use-node-even-on-non-node-projects
...
taxonomy:
  tags:
    ...
    - nodejs
  categories: []
canonicalUrl: /blog/always-use-node-even-on-non-node-projects/
legacyUrls:
...
meta:
  sourceMeta:
    ...
    tags:
      ...
      - npm
      - nodejs
    date: 2014-10-09T22:09:12.000Z
    social_image: node-logo.png
    description: >-
      That's right. I said it: Always use Node, no matter what! Even if your
      server isn't going to be a Node server, just have it installed because
      you'll use it.
---
