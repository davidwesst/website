---
id: blog/using-java-build-script-tasks-in-visual-studio-code
source: davidwesst.github.io
docType: post
series: blog
slug: using-java-build-script-tasks-in-visual-studio-code
...
taxonomy:
  tags:
    ...
    - visual-studio-code
  categories: []
canonicalUrl: /blog/using-java-build-script-tasks-in-visual-studio-code/
legacyUrls:
  - /blog/using-java-build-script-tasks-in-visual-studio-code/index.html
meta:
  sourceMeta:
    title: Using Java Build Script Tasks in Visual Studio Code
    date: 2015-10-21T08:18:19.000Z
    tags:
      - java
      - vscode
      - visual-studio-code
