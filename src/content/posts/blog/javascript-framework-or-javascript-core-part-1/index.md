---
id: blog/javascript-framework-or-javascript-core-part-1
source: davidwesst.github.io
docType: post
series: blog
slug: javascript-framework-or-javascript-core-part-1
title: JavaScript Framework or JavaScript Core (Part 1)
summary: >-
  Is it always better to use JavaScript Frameworks? David analyzes the pros and
  cons of using JavaScript frameworks versus only using core JavaScript.
dates:
...
taxonomy:
  tags:
    - javascript
  categories: []
canonicalUrl: /blog/javascript-framework-or-javascript-core-part-1/
legacyUrls:
  - /blog/javascript-framework-or-javascript-core-part-1/index.html
meta:
  sourceMeta:
    title: JavaScript Framework or JavaScript Core (Part 1)
    date: 2016-02-16T15:34:46.000Z
    tags:
      - javascript
    description: >-
      Is it always better to use JavaScript Frameworks? David analyzes the pros
      and cons of using JavaScript frameworks versus only using core JavaScript.
---
