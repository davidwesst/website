---
id: blog/how-to-fix-node-gyp-error-on-windows
source: davidwesst.github.io
docType: post
series: blog
slug: how-to-fix-node-gyp-error-on-windows
...
taxonomy:
  tags:
    ...
    - node-gyp
  categories: []
canonicalUrl: /blog/how-to-fix-node-gyp-error-on-windows/
legacyUrls:
  - /blog/how-to-fix-node-gyp-error-on-windows/index.html
meta:
  sourceMeta:
    title: How to Fix node-gyp Error on Windows
    date: 2016-09-26T14:51:56.000Z
    tags:
      - nodejs
      - javascript
      - node-gyp
    description: >-
      Whenever I get a new machine, I pull down a new project using the `npm
      install command and get an error related to python and node-gyp. This post
      will remember the fix for this problem that I always forget.
---
