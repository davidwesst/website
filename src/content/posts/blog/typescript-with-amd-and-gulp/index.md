---
id: blog/typescript-with-amd-and-gulp
source: davidwesst.github.io
docType: post
series: blog
slug: typescript-with-amd-and-gulp
...
taxonomy:
  tags:
    ...
    - gulp
  categories: []
canonicalUrl: /blog/typescript-with-amd-and-gulp/
legacyUrls:
  - /blog/typescript-with-amd-and-gulp/index.html
meta:
  sourceMeta:
    title: How to Compile Typescript into a Single File with AMD Modules with Gulp
    date: 2016-09-12T08:25:01.000Z
    tags:
      - typescript
      - javascript
      - amd
      ...
      - gulp
    description: >-
      The lessons I learned and the steps I took to compile TypeScript modules
      into a single file with AMD modules using Gulp, along with how I consumed
      those compiled modules in my HTML application.
---
