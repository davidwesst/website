---
id: blog/how-to-build-reactjs-with-gulp
source: davidwesst.github.io
docType: post
series: blog
slug: how-to-build-reactjs-with-gulp
...
taxonomy:
  tags:
    ...
    - babel
  categories: []
canonicalUrl: /blog/how-to-build-reactjs-with-gulp/
legacyUrls:
  - /blog/how-to-build-reactjs-with-gulp/index.html
meta:
  sourceMeta:
    title: How to Build ReactJS with Gulp
    date: 2016-09-19T19:55:48.000Z
    tags:
      - reactjs
      - gulp
      - javascript
      - babel
    description: >-
      I started to tinker with React last week and needed to do some digging on
      how to transpile the React JSX files using Gulp. In this post, we
