---
id: blog/javascript-framework-or-javascript-core-part-2
source: davidwesst.github.io
docType: post
series: blog
slug: javascript-framework-or-javascript-core-part-2
...
taxonomy:
  tags:
    - javascript
  categories: []
canonicalUrl: /blog/javascript-framework-or-javascript-core-part-2/
legacyUrls:
  - /blog/javascript-framework-or-javascript-core-part-2/index.html
meta:
  sourceMeta:
    title: JavaScript Framework or JavaScript Core (Part 2)
    date: 2016-02-22T15:34:46.000Z
    tags:
      - javascript
    description: >-
      Is it always better to use JavaScript Frameworks? David continues his
      analysys and shares the pros and cons of writing your JavaScript from
      scratch.
---
![][5]
