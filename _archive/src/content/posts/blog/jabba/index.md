...
taxonomy:
  tags:
    ...
    - jabba
  categories: []
canonicalUrl: /blog/jabba/
legacyUrls:
  - /blog/jabba/index.html
meta:
  sourceMeta:
    title: 'Jabba, the Java Version Manager for Everyone'
    date: 2017-08-16T09:35:00.000Z
    tags:
      - java
      - powershell
      - version-manager
      - jabba
    description: >-
      Here's another dev thing I use: Jabba, a cross-platform Java version
      manager that works for Windows.
---
