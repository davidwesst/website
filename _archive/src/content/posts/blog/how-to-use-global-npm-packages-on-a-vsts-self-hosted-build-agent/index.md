---
id: blog/how-to-use-global-npm-packages-on-a-vsts-self-hosted-build-agent
source: davidwesst.github.io
docType: post
series: blog
slug: how-to-use-global-npm-packages-on-a-vsts-self-hosted-build-agent
title: How to Use Global NPM Packages on a VSTS Self-Hosted Build Agent
summary: >-
  I setup a self-hosted build agent in Visual Studio Team Services. My build
...
taxonomy:
  tags:
    ...
    - npm
  categories: []
canonicalUrl: /blog/how-to-use-global-npm-packages-on-a-vsts-self-hosted-build-agent/
legacyUrls:
  - >-
    /blog/how-to-use-global-npm-packages-on-a-vsts-self-hosted-build-agent/index.html
meta:
  sourceMeta:
    title: How to Use Global NPM Packages on a VSTS Self-Hosted Build Agent
    date: 2016-10-24T08:33:01.000Z
    tags:
      - javascript
      - visual-studio-team-services
      - nodejs
    ...
    description: >-
      I setup a self-hosted build agent in Visual Studio Team Services. My build
      installed global NPM packages, but the tasks that used them later on in
      the script would fail because they were unable to use them. This post
