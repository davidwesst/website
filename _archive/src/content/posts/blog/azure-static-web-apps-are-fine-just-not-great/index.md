---
id: blog/azure-static-web-apps-are-fine-just-not-great
source: davidwesst.github.io
docType: post
series: blog
slug: azure-static-web-apps-are-fine-just-not-great
...
taxonomy:
  tags:
    ...
    - azure-functions
  categories: []
canonicalUrl: /blog/azure-static-web-apps-are-fine-just-not-great/
legacyUrls:
  - /blog/azure-static-web-apps-are-fine-just-not-great/index.html
meta:
  sourceMeta:
    title: 'Azure Static Web Apps (SWA) are fine, just not great'
    ...
    tags:
      ...
      - azure-functions
    description: >-
      Azure Static Web Apps feel like a good idea, but in practice I struggled
      with understanding what the product is trying to be. This post documents
      my experience working with SWAs on a few projects, namely this website,
      along with the problems and workarounds/solutions I found to those
      problems.
---
