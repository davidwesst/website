---
id: blog/does-gdpr-apply-to-personal-websites
source: davidwesst.github.io
docType: post
series: blog
slug: does-gdpr-apply-to-personal-websites
...
media:
  ...
  imageAlt: >-
    A chocolate chip cookie on a white surface with a bite taken out of it and
    crumbs scattered about the surface. The letters 'GDPR' are printed on the
    top of the cookie with black lettering with a white border.
  mediaType: image/png
  credit:
    derived_from: >-
      https://unsplash.com/photos/z8kriatLFdA?utm_source=unsplash&utm_medium=referral&utm_content=creditShareLink
canonicalUrl: /blog/does-gdpr-apply-to-personal-websites/
legacyUrls:
  - /blog/does-gdpr-apply-to-personal-websites/index.html
meta:
  sourceMeta:
    title: Does GDPR Apply to Personal Websites?
    ...
    tags:
      ...
      - website
    description: >-
      While rebuilding my personal website in 2022, I wanted to know how or if
      GDPR applied to my little side project. My internet sleuthing did not
